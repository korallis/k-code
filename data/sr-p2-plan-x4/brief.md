...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/Users/leebarry/firstmate/state/sr-p2-plan-x4.status'`
...
# Definition of done
Write your findings to `/Users/leebarry/firstmate/data/sr-p2-plan-x4/report.md`.
