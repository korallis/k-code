...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/Users/leebarry/firstmate/state/kz-p4-plan-c5.status'`
...
# Definition of done
Write your findings to `/Users/leebarry/firstmate/data/kz-p4-plan-c5/report.md`.
