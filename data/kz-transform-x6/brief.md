...
4. Report status by appending one line:
   `echo "{state}: {one short line}" >> '/Users/leebarry/firstmate/state/kz-transform-x6.status'`
...
# Definition of done
Write your findings to `/Users/leebarry/firstmate/data/kz-transform-x6/report.md`.
